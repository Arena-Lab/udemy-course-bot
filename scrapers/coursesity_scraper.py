"""
Scraper for Coursesity website
"""
...
class CoursesityScraper(BaseScraper):
    """Scraper for coursesity.com website"""
    
    def __init__(self):
        super().__init__('coursesity', 'https://coursesity.com/provider/free/udemy-courses')
    
    def scrape_courses(self, limit: int = None) -> List[Dict]:
        """Scrape courses from Coursesity"""
        courses = []
        ...
        try:
            ...
            if not course_elements:
                course_elements = soup.find_all('div', class_='card')
    ...
    def _extract_course_data(self, element) -> Dict:
        ...
        try:
            ...
            if link_elem:
                href = link_elem['href']
                if href.startswith('/'):
                    course_data['course_url'] = 'https://coursesity.com' + href
                else:
            ...
            if img_elem and img_elem.get('src'):
                ...
                if img_src.startswith('/'):
                    course_data['image_url'] = 'https://coursesity.com' + img_src
                else:
